...
# Site Execution Milestone Grid Model (same structure as MilestoneGrid but separate table)
class SiteExecutionMilestoneGrid(Base):
    __tablename__ = "site_execution_milestone_grid"
